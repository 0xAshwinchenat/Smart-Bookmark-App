    ...
    <div className="flex items-center justify-center min-h-screen bg-muted/30">
      <Card className="w-full max-w-md shadow-lg border-2">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription>
            Log in to your SmartMark account to manage your bookmarks.
          </CardDescription>
        </CardHeader>
        <CardContent className="grid gap-4">
          <Button 
            variant="outline" 
            className="w-full py-6 text-base font-medium border-2 hover:bg-muted/50 transition-all flex items-center justify-center gap-3"
